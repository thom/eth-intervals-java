...
public class IntReduction {
	 ...
	 * {@link #add(int)} or {@link #subtract(int)}.
	 * 
	 ...
	 * <p>
	 * A data-race occurs if this method overlaps with calls to
	 * {@link #add(int)}, {@link #subtract(int)}, {@link #reduce()} etc.
	 */
	 ...
	 * {@link #add(int)} or {@link #subtract(int)} that have occurred
	 * since the last {@link #reduce()} or {@link #resetAll(int)}.
	 * 
	 * <p>
	 * A data-race occurs if this method overlaps with calls to
	 * {@link #reduce()}, {@link #resetAll(int)}, or
	 * {@link #setValue(int)}.
	 */
	 ...
	 * <p>
	 * A data-race occurs if this method overlaps with calls to
	 * {@link #reduce()}, {@link #resetAll(int)}, or {@link #value()}.
	 */
