...
public class TestIllegalEdges {
	...
	private void addIllegalEdge(Point from, Point to,
			Class<? extends IntervalException> err) {
		try {
	...
	public void testMBBB() {
		Intervals.inline(new VoidInlineTask() {
			...
			public void run(Interval a) {
				...
				addIllegalEdge(a12.start, a2.end,
						MustBeBoundedByException.class);
				addIllegalEdge(a12.end, a2.end, MustBeBoundedByException.class);
				addIllegalEdge(a12.start, a2.start,
						MustBeBoundedByException.class);
				addIllegalEdge(a12.end, a2.start,
						MustBeBoundedByException.class);

				addIllegalEdge(a12.start, b.start,
						MustBeBoundedByException.class);
	...
	public void testMBBBWithSub() {
		Intervals.inline(new VoidInlineTask() {
			...
			public void run(Interval a) {
				...
				addIllegalEdge(h.a12.start, h.a2.end,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.end, h.a2.end,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.start, h.a2.start,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.end, h.a2.start,
						MustBeBoundedByException.class);

				addIllegalEdge(h.a12.start, h.b.start,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.end, h.b.start,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.start, h.b.end,
						MustBeBoundedByException.class);
				addIllegalEdge(h.a12.end, h.b.end,
						MustBeBoundedByException.class);
			}
		...
		try {
			Intervals.inline(new VoidInlineTask() {
				...
				public void run(Interval subinterval) {
					final Interval a = new TestInterval.IncTask(subinterval,
							"a", integer);
